...
; ANIM_OBJ_HAIL
	battleanimobj RELATIVE_X | X_FLIP, $00, BATTLEANIMFRAMESET_HAIL, BATTLE_ANIM_FUNC_RAIN_SANDSTORM, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_ICE
...
; ANIM_OBJ_MOONBLAST
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_MOONBLAST, BATTLE_ANIM_FUNC_USER_TO_TARGET_DISAPPEAR, PAL_BATTLE_OB_YELLOW, BATTLE_ANIM_GFX_CHARGE
...
; ANIM_OBJ_BLUE_FLAME
	battleanimobj RELATIVE_X, $90, BATTLE_ANIM_FRAMESET_BURNED, BATTLE_ANIM_FUNC_MOVE_IN_CIRCLE, PAL_BATTLE_OB_BLUE, BATTLE_ANIM_GFX_FIRE
...
; ANIM_OBJ_STONE_EDGE
	battleanimobj RELATIVE_X, $ff, BATTLE_ANIM_FRAMESET_SMALL_ROCK, BATTLE_ANIM_FUNC_MOVE_UP, PAL_BATTLE_OB_BROWN, BATTLE_ANIM_OBJ_PALM
