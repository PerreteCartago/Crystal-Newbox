...
; BattleTowerMons group 4
	...
	db OMASTAR
	db GOLD_BERRY
	db CURSE, SCALD, ANCIENTPOWER, ROCK_SMASH
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 5
	...
	db ELECTRODE
	db MIRACLEBERRY
	db THUNDERBOLT, SELFDESTRUCT, MIRROR_COAT, REST
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GYARADOS
	db MIRACLEBERRY
	db HYPER_BEAM, SURF, RAIN_DANCE, EARTHQUAKE
	dw 0 ; OT ID
	dt 125000 ; Exp
	; Stat exp
	bigdw 40000
...
; BattleTowerMons group 6
	...
	db GOLEM
	db BRIGHTPOWDER
	db SELFDESTRUCT, EARTHQUAKE, FIRE_PUNCH, FRUSTRATION
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
; BattleTowerMons group 8
	...
	db ELECTRODE
	db KINGS_ROCK
	db THUNDERBOLT, SELFDESTRUCT, MIRROR_COAT, TOXIC
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 9
	...
	db CLOYSTER
	db LEFTOVERS
	db SELFDESTRUCT, BLIZZARD, SURF, ICY_WIND
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
...
; BattleTowerMons group 10
	...
	db ELECTRODE
	db BRIGHTPOWDER
	db THUNDER_WAVE, THUNDERBOLT, SELFDESTRUCT, MIRROR_COAT
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 45000
