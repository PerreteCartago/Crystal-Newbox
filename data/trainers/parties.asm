...
FalknerGroup:
	; FALKNER (1)
	db "Pegaso@", TRAINERTYPE_DVS | TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
	db  18, PIDGEOTTO
		db PERFECT_DV, $de ; atk|def, spd|spc
		dw $4FFF, $4FFF, $4FFF, $4FFF, $4FFF ; hp, atk, def, spd, spc
		db SHARP_BEAK
		db WING_ATTACK, SWORDS_DANCE, MUD_SLAP, GUST
	db  18, DELIBIRD
		db PERFECT_DV, $de ; atk|def, spd|spc
		dw $4FFF, $4FFF, $4FFF, $4FFF, $4FFF ; hp, atk, def, spd, spc
		db NEVERMELTICE
...
WhitneyGroup:
	; WHITNEY (1)
	db "Blanca@", TRAINERTYPE_DVS | TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
	db  24, CLEFAIRY
		db PERFECT_DV, $de ; atk|def, spd|spc
		dw $6FFF, $6FFF, $6FFF, $6FFF, $6FFF ; hp, atk, def, spd, spc
		db LUCKY_PUNCH
	...
	db  24, WIGGLYTUFF
		...
		dw $6FFF, $6FFF, $6FFF, $6FFF, $6FFF ; hp, atk, def, spd, spc
		db POLKADOT_BOW
		db SING, PLAY_ROUGH, RECOVER, DEFENSE_CURL
	db  24, TAUROS
		db PERFECT_DV, $de ; atk|def, spd|spc
		dw $6FFF, $6FFF, $6FFF, $6FFF, $6FFF ; hp, atk, def, spd, spc
		db KINGS_ROCK
		db THRASH, IRON_TAIL, EARTHQUAKE, SWORDS_DANCE
	db  24, KANGASKHAN
		db PERFECT_DV, $de ; atk|def, spd|spc
		dw $6FFF, $6FFF, $6FFF, $6FFF, $6FFF ; hp, atk, def, spd, spc
		db GOLD_BERRY
...
BugsyGroup:
	; BUGSY (1)
	db "Antón@", TRAINERTYPE_DVS | TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
	db  12, SHUCKLE
		db PERFECT_DV, $de ; atk|def, spd|spc
	...
	db  12, BEEDRILL
		...
		dw $2FFF, $2FFF, $2FFF, $2FFF, $2FFF ; hp, atk, def, spd, spc
		db SILVERPOWDER
		db FURY_CUTTER, FURY_SWIPES, TWINEEDLE, POISON_STING
	db  12, SCYTHER
		db PERFECT_DV, $de ; atk|def, spd|spc
		dw $2FFF, $2FFF, $2FFF, $2FFF, $2FFF ; hp, atk, def, spd, spc
		db QUICK_CLAW
		db PURSUIT, DOUBLE_TEAM, SLASH, FURY_CUTTER
	db  12, PINSIR
		db PERFECT_DV, $de ; atk|def, spd|spc
		dw $2FFF, $2FFF, $2FFF, $2FFF, $2FFF ; hp, atk, def, spd, spc
		db LEFTOVERS
		db PIN_MISSILE, GUILLOTINE, FURY_CUTTER, BIND
	db  12, BUTTERFREE
		db PERFECT_DV, $de ; atk|def, spd|spc
		dw $2FFF, $2FFF, $2FFF, $2FFF, $2FFF ; hp, atk, def, spd, spc
		db KINGS_ROCK
		db CONFUSION, WING_ATTACK, WHIRLWIND, SLEEP_POWDER
	db -1 ; end
...
Rival1Group:
	...
	db  7, TOTODILE,   LEER, GROWL, NO_MOVE, NO_MOVE
	db -1 ; end
...
YoungsterGroup:
	...
	; YOUNGSTER (13)
	db "Chano@", TRAINERTYPE_ITEM_MOVES
	...
	db 45, RATICATE,   LEFTOVERS,      LEER, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
	...
	db 59, RATICATE,   LEFTOVERS,      LEER, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
SchoolboyGroup:
	...
	db 58, XATU,       PECK, HEX, SWIFT, FUTURE_SIGHT
	db 58, TANGELA,    POISONPOWDER, VINE_WHIP, BIND, MEGA_DRAIN
	db 58, YANMA,      QUICK_ATTACK, DOUBLE_TEAM, BUG_BUZZ, SUPERSONIC
	db 58, QUAGSIRE,   EARTH_POWER, SLAM, AMNESIA, EARTHQUAKE
...
BirdKeeperGroup:
	; BIRD_KEEPER (1)
	db "Rony@", TRAINERTYPE_MOVES
	db 16, FARFETCH_D, PECK, FURY_CUTTER, SAND_ATTACK, RAZOR_LEAF
	db 16, SPEAROW,    STEEL_WING, SWIFT, PECK, FURY_SWIPES
	db 16, AERODACTYL, WING_ATTACK, AGILITY, BITE, ANCIENTPOWER
	db 16, PIDGEY,     GUST, MUD_SLAP, SCRATCH, FLASH
	db 16, DODUO,      PECK, GROWL, PURSUIT, PROTECT
	db -1 ; end

	; BIRD_KEEPER (2)
	db "Abel@", TRAINERTYPE_MOVES
	db 16, SPEAROW,    SWIFT, PECK, FURY_SWIPES, MUD_SLAP
	db 16, MURKROW,    PECK, PURSUIT, PROTECT, NO_MOVE
	db 16, PIDGEY,     GUST, MUD_SLAP, SCRATCH, FLASH
	db 16, TOGETIC,    METRONOME, GROWL, SWIFT, DOUBLE_EDGE
	db 16, DODUO,      PECK, GROWL, PURSUIT, PROTECT
	db -1 ; end
...
LassGroup:
	...
	db 22, FURRET,     SLASH, SWORDS_DANCE, SCRATCH, LEER
	db 22, SNORLAX,    REST, CHARM, HEADBUTT, ROLLOUT
	db 22, TAUROS,     SLASH, RAGE, EARTHQUAKE, NO_MOVE
	db 22, CHANSEY,    MOONBLAST, CHARM, SING, DEFENSE_CURL
	db 22, BLISSEY,    SOFTBOILED, DOUBLE_EDGE, SING, EGG_BOMB
	db -1 ; end
...
JanineGroup:
	...
	db 36, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, SELFDESTRUCT
	db 33, ARIADOS,    SCARY_FACE, GIGA_DRAIN, STRING_SHOT, HEX
...
CooltrainerMGroup:
	...
	db 26, SQUIRTLE,   ACID_ARMOR, BUBBLE, BITE, CURSE
...
BeautyGroup:
	...
	db 22, PERSIAN,    SCRATCH, GROWL, BITE, SLASH
	db 22, GIRAFARIG,  PSYCHIC_M, STOMP, BITE, PAY_DAY
	db 22, JIGGLYPUFF, SING, DEFENSE_CURL, PLAY_ROUGH, RECOVER
	db 22, MILTANK,    MILK_DRINK, STOMP, ROLLOUT, MOONBLAST
	db 22, LICKITUNG,  LICK, GROWL, HEADBUTT, REST
	db -1 ; end
...
PokemaniacGroup:
	...
	db 20, LICKITUNG,  LICK, SUPERSONIC, CUT, HEADBUTT
	db -1 ; end
...
BugCatcherGroup:
	...
	db 46, FORRETRESS, DOUBLE_EDGE, SPIKES, SELFDESTRUCT, EARTHQUAKE
	...
	db 57, FORRETRESS, DOUBLE_EDGE, SPIKES, SELFDESTRUCT, EARTHQUAKE
	...
	db 61, FORRETRESS, DOUBLE_EDGE, SPIKES, SELFDESTRUCT, EARTHQUAKE
...
FisherGroup:
	...
	db 62, QWILFISH,   TOXIC, MINIMIZE, SURF, POISON_JAB
	db 62, SEAKING,    ENDURE, FLAIL, HORN_DRILL, WATERFALL
...
HikerGroup:
	...
	db 58, STEELIX,    IRON_TAIL, EARTHQUAKE, ACID_ARMOR, DEFENSE_CURL
...
PsychicGroup:
	...
	db 26, HYPNO,    HYPNOSIS, DISABLE, DREAM_EATER, ZEN_HEADBUTT
	db -1 ; end
	...
	db 23, MR__MIME,   TELEPORT, CONFUSION, BARRIER, MIMIC
	db 23, KADABRA,    TELEPORT, FLASH, CONFUSION, NO_MOVE
	db 23, NATU,       WING_ATTACK, SHADOW_BALL, DOUBLE_TEAM, FLASH
	db -1 ; end
...
PicnickerGroup:
	...
	db 21, PIKACHU,    THUNDERSHOCK, GROWL, QUICK_ATTACK, DOUBLE_TEAM
	db -1 ; end
	...
	db 51, NIDOQUEEN,  EARTHQUAKE, DOUBLE_KICK, LEER, BODY_SLAM
...
PokefanFGroup:
	...
	db 25, SNUBBULL,   GOLD_BERRY
	db 25, JIGGLYPUFF, POLKADOT_BOW
	db 25, PIKACHU,    LIGHT_BALL
	db -1 ; end
