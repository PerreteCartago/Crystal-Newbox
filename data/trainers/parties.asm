...
LassGroup:
	...
	; LASS (17)
	db "Geno@", TRAINERTYPE_NORMAL
	db 41, CLEFAIRY
	db 41, CLEFABLE
	db -1 ; end

	; LASS (18)
	db "Lulú@", TRAINERTYPE_NORMAL
	db 41, NIDORAN_F
	db 41, NIDORINA
	db 41, NIDOQUEEN
	db -1 ; end
...
BeautyGroup:
	...
	; BEAUTY (3)
	db "Lucrecia@", TRAINERTYPE_NORMAL
	db 41, PIDGEOTTO
	db 42, PIDGEOT
	db -1 ; end

	; BEAUTY (4)
	db "Susana@", TRAINERTYPE_NORMAL
	db 41, RATICATE
	db 42, NIDOQUEEN
	db -1 ; end

	; BEAUTY (5)
	db "Roberta@", TRAINERTYPE_NORMAL
	db 45, WIGGLYTUFF
	db -1 ; end
...
BugCatcherGroup:
	...
	; BUG_CATCHER (20)
	db "Cirilo@", TRAINERTYPE_MOVES
	db 44, BUTTERFREE,   SAFEGUARD, BUG_BUZZ, PSYCHIC_M, AIR_SLASH
	db 44, PIKACHU,   SPARK, AGILITY, PLAY_ROUGH, LIGHT_SCREEN
	db 44, BEEDRILL,   AGILITY, POISON_JAB, FURY_SWIPES, PIN_MISSILE
	db -1 ; end
	...
	; BUG_CATCHER (23)
	db "Asier@", TRAINERTYPE_MOVES
	db 50, ARIADOS,   AGILITY, PIN_MISSILE, PSYCHIC_M, POISON_JAB
	db -1 ; end

	; BUG_CATCHER (24)
	db "Manilo@", TRAINERTYPE_NORMAL
	db 44, BEEDRILL
	db 46, BUTTERFREE
	db -1 ; end
	...
	; BUG_CATCHER (31)
	db "Casimiro@", TRAINERTYPE_NORMAL
	db 40, BEEDRILL
	db 40, BEEDRILL
	db 40, BEEDRILL
	db -1 ; end
...
HikerGroup:
	...
	; HIKER (26)
	db "Adolfo@", TRAINERTYPE_NORMAL
	db 40, STEELIX
	db 40, MACHAMP
	db -1 ; end

	; HIKER (27)
	db "Alfonso@", TRAINERTYPE_NORMAL
	db 40, GOLEM
	db 40, STEELIX
	db -1 ; end

	; HIKER (28)
	db "Baltasar@", TRAINERTYPE_NORMAL
	db 40, GRAVELER
	db 40, GOLEM
	db 40, MACHAMP
	db -1 ; end
	...
	; HIKER (33)
	db "Alfredo@", TRAINERTYPE_NORMAL
	db 45, GOLEM
	db -1 ; end

	; HIKER (34)
	db "Evaristo@", TRAINERTYPE_NORMAL
	db 40, MACHAMP
	db 40, ONIX
	db -1 ; end

	; HIKER (35)
	db "Dinio@", TRAINERTYPE_NORMAL
	db 40, GRAVELER
	db 40, GOLEM
	db 50, TYRANITAR
	db -1 ; end
...
CamperGroup:
	...
	; CAMPER (9)
	db "Richi@", TRAINERTYPE_NORMAL
	db 39, WARTORTLE
	db -1 ; end

	; CAMPER (10)
	db "Genaro@", TRAINERTYPE_NORMAL
	db 38, RATICATE
	db 38, FEAROW
	db -1 ; end
...
PiGroup:
	; PI (1)
	db "Hugue@", TRAINERTYPE_NORMAL
	db 40, POLIWHIRL
	db 40, SEADRA
	db -1 ; end

	; PI (2)
	db "Jaren@", TRAINERTYPE_NORMAL
	db 40, WEEPINBELL
	db 40, VILEPLUME
	db -1 ; end
	...
	; PI (5)
	db "Norber@", TRAINERTYPE_NORMAL
	db 40, ARCANINE
	db 40, RAPIDASH
	db -1 ; end

	; PI (6)
	db "Eusebio@", TRAINERTYPE_NORMAL
	db 40, POLIWAG
	db 40, POLIWHIRL
	db 40, POLIWRATH
	db -1 ; end
...
EngineerGroup:
	; ENGINEER (1)
	db "Bernardo@", TRAINERTYPE_NORMAL
	db 39, MAGNETON
	db 39, MAGNETON
	db 39, MAGNETON
	db -1 ; end
	...
	; ENGINEER (2)
	db "Perico@", TRAINERTYPE_NORMAL
	db 42, MAGNETON
	db -1 ; end

SchoolgirlGroup:
	; SCHOOLGIRL (1)
	db "Betina@", TRAINERTYPE_NORMAL
	db 35, PIKACHU
	db 35, CLEFAIRY
	db -1 ; end
