...
BirdKeeperGroup:
	...
	db 12, FARFETCH_D, PECK, FURY_CUTTER, SAND_ATTACK, RAZOR_LEAF
	db 12, SPEAROW,    STEEL_WING, SWIFT, PECK, FURY_SWIPES
	db 12, AERODACTYL, WING_ATTACK, AGILITY, BITE, ANCIENTPOWER
	db 12, PIDGEY,     GUST, MUD_SLAP, SCRATCH, FLASH
	db 12, DODUO,      PECK, GROWL, PURSUIT, PROTECT
	db -1 ; end

	; BIRD_KEEPER (2)
	db "ABE@", TRAINERTYPE_MOVES
	db 12, SPEAROW,    SWIFT, PECK, FURY_SWIPES, MUD_SLAP
	db 12, MURKROW,    PECK, PURSUIT, PROTECT, NO_MOVE
	db 12, PIDGEY,     GUST, MUD_SLAP, SCRATCH, FLASH
	db 12, TOGETIC,    METRONOME, GROWL, SWIFT, DOUBLE_EDGE
	db 12, DODUO,      PECK, GROWL, PURSUIT, PROTECT
	db -1 ; end
