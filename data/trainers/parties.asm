...
FalknerGroup:
	...
	db  18, PIDGEOTTO
		...
		db SHARP_BEAK
		db WING_ATTACK, SWORDS_DANCE, MUD_SLAP, NO_MOVE
	db  18, DELIBIRD
		db PERFECT_DV, $de ; atk|def, spd|spc
		dw $4FFF, $4FFF, $4FFF, $4FFF, $4FFF ; hp, atk, def, spd, spc
		db NEVERMELTICE
...
BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_DVS | TRAINERTYPE_STAT_EXP | TRAINERTYPE_ITEM_MOVES
	db  12, SHUCKLE
		db PERFECT_DV, $de ; atk|def, spd|spc
	...
	db  12, BEEDRILL
		...
		dw $2FFF, $2FFF, $2FFF, $2FFF, $2FFF ; hp, atk, def, spd, spc
		db SILVERPOWDER
		db BUG_BUZZ, FURY_SWIPES, TWINEEDLE, POISON_JAB
	db  12, SCYTHER
		db PERFECT_DV, $de ; atk|def, spd|spc
		dw $2FFF, $2FFF, $2FFF, $2FFF, $2FFF ; hp, atk, def, spd, spc
		db QUICK_CLAW
		db PURSUIT, DOUBLE_TEAM, SLASH, WING_ATTACK
	db  12, PINSIR
		db PERFECT_DV, $de ; atk|def, spd|spc
		dw $2FFF, $2FFF, $2FFF, $2FFF, $2FFF ; hp, atk, def, spd, spc
		db LEFTOVERS
		db X_SCISSOR, GUILLOTINE, SLASH, BIND
	db  12, BUTTERFREE
		db PERFECT_DV, $de ; atk|def, spd|spc
		dw $2FFF, $2FFF, $2FFF, $2FFF, $2FFF ; hp, atk, def, spd, spc
		db KINGS_ROCK
...
SchoolboyGroup:
	...
	db 35, XATU,       PECK, HEX, SWIFT, FUTURE_SIGHT
	db 32, TANGELA,    POISONPOWDER, VINE_WHIP, BIND, MEGA_DRAIN
	db 32, YANMA,      QUICK_ATTACK, DOUBLE_TEAM, PSYCHIC_M, SUPERSONIC
