...
MapGroup_Dungeons:
	...
	map CianwoodCave, TILESET_CAVE, CAVE, LANDMARK_CIANWOOD_CAVE, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCave1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCave2F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCaveB1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower1F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower2F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower3F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower4F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower5F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower6F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower7F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslands, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB1F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB2F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB3F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB4F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PowerPlantGrande, TILESET_FACILITY, CAVE, LANDMARK_POWER_PLANT, MUSIC_POKEMON_MANSION, TRUE, PALETTE_DAY, FISHGROUP_LAKE
...
MapGroup_Cinnabar:
	...
	map CinnabarMart, TILESET_POKECENTER, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route19FuchsiaGate, TILESET_GATE, GATE, LANDMARK_ROUTE_19, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SeafoamGym, TILESET_CAVE, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CinnabarLab, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarLabFossilRoom, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarLabMetronomeRoom, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarLabTradeRoom, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map CeruleanMart, TILESET_POKECENTER, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map MtMoonPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ROUTE_4, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map ViridianNorthGate, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianSouthGate, TILESET_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForest, TILESET_FOREST, FOREST, LANDMARK_VIRIDIAN_FOREST, MUSIC_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
