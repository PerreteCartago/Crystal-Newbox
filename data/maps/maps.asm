...
MapGroup_Olivine:
	...
	map Route38RivalPokemonHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_38, MUSIC_ROUTE_37, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Mahogany:
	...
	map Route44House, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ROUTE_44, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_DAY, FISHGROUP_REMORAID
...
MapGroup_Dungeons:
	...
	map RockTunnel1F, TILESET_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map RockTunnelB1F, TILESET_CAVE, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	...
	map CianwoodCave, TILESET_CAVE, CAVE, LANDMARK_CIANWOOD_CAVE, MUSIC_SILPH_CO, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCave1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_DUNGEONS_1, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCave2F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_DUNGEONS_1, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCaveB1F, TILESET_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_DUNGEONS_1, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower1F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower2F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower3F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower4F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower5F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower6F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PokemonTower7F, TILESET_MART, CAVE, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_TOWER, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslands, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEONS_2, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB1F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEONS_2, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB2F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEONS_2, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB3F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEONS_2, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map SeafoamIslandsB4F, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DUNGEONS_2, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map PowerPlantGrande, TILESET_FACILITY, CAVE, LANDMARK_POWER_PLANT, MUSIC_DUNGEONS_1, TRUE, PALETTE_DAY, FISHGROUP_LAKE
	map MonteMoonGrande1F, TILESET_CAVE, CAVE, LANDMARK_MT_MOON, MUSIC_DUNGEONS_3, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MonteMoonGrandeB1F, TILESET_CAVE, CAVE, LANDMARK_MT_MOON, MUSIC_DUNGEONS_3, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map MonteMoonGrandeB2F, TILESET_CAVE, CAVE, LANDMARK_MT_MOON, MUSIC_DUNGEONS_3, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Ecruteak:
	...
	map EcruteakWillOWispHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Blackthorn:
	...
	map MoveReminderHouse, TILESET_HOUSE, INDOOR, LANDMARK_BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_BLACKTHORN_MAPS

MapGroup_Cinnabar:
	table_width MAP_LENGTH, MapGroup_Cinnabar
	map CinnabarPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarMart, TILESET_POKECENTER, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route19FuchsiaGate, TILESET_GATE, GATE, LANDMARK_ROUTE_19, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SeafoamGym, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_GYM_KANTO, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map PokemonMansion1F, TILESET_FACILITY, CAVE, LANDMARK_#MON_MANSION, MUSIC_POKEMON_MANSION, TRUE, PALETTE_DAY, FISHGROUP_LAKE
	map PokemonMansion2F, TILESET_FACILITY, CAVE, LANDMARK_#MON_MANSION, MUSIC_POKEMON_MANSION, TRUE, PALETTE_DAY, FISHGROUP_LAKE
	map PokemonMansion3F, TILESET_FACILITY, CAVE, LANDMARK_#MON_MANSION, MUSIC_POKEMON_MANSION, TRUE, PALETTE_DAY, FISHGROUP_LAKE
	map PokemonMansionB1F, TILESET_FACILITY, CAVE, LANDMARK_#MON_MANSION, MUSIC_POKEMON_MANSION, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CinnabarLab, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarLabFossilRoom, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarLabMetronomeRoom, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarLabTradeRoom, TILESET_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_CINNABAR_MAPS

MapGroup_Cerulean:
	table_width MAP_LENGTH, MapGroup_Cerulean
	map CeruleanGymBadgeSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPoliceStation, TILESET_HOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanGym, TILESET_PORT, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_GYM_KANTO, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map CeruleanMart, TILESET_POKECENTER, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route10Pokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ROUTE_10, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route10Pokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_ROUTE_10, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PowerPlant, TILESET_FACILITY, INDOOR, LANDMARK_POWER_PLANT, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_25, MUSIC_ROUTES_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route4East, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_4, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	...
	map Route24, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_24, MUSIC_ROUTES_2, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route25, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_25, MUSIC_ROUTES_2, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map CeruleanCity, TILESET_KANTO, TOWN, LANDMARK_CERULEAN_CITY, MUSIC_CITIES_2, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map MtMoonPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_ROUTE_4, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanBulbasaurHouse, TILESET_HOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanBikeShop, TILESET_CHAMPIONS_ROOM, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CITIES_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5UndergroundPathEntrance, TILESET_GATE, GATE, LANDMARK_ROUTE_5, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5SaffronGate1F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_5, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5SaffronGate2F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_5, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Azalea:
	...
	map AzaleaGym, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Violet:
	...
	map VioletGym, TILESET_ELITE_FOUR_ROOM, INDOOR, LANDMARK_AZALEA_TOWN, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Goldenrod:
	...
	map GoldenrodDeptStore1F, TILESET_POKECENTER, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore2F, TILESET_POKECENTER, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore3F, TILESET_POKECENTER, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore4F, TILESET_POKECENTER, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore5F, TILESET_POKECENTER, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStore6F, TILESET_POKECENTER, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodDeptStoreElevator, TILESET_POKECENTER, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ScaldHouse, TILESET_HOUSE, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodLab, TILESET_RADIO_TOWER, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodLabB1, TILESET_LAB, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Vermilion:
	...
	map VermilionPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map VermilionGym, TILESET_GAME_CORNER, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_GYM_KANTO, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route11Gate1F, TILESET_MUSEUM, INDOOR, LANDMARK_ROUTE_11, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route11Gate2F, TILESET_MUSEUM, INDOOR, LANDMARK_ROUTE_11, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterMart, TILESET_POKECENTER, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route4West, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_3, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_Indigo:
	...
	map Route23, TILESET_JOHTO_MODERN, TOWN, LANDMARK_ROUTE_23, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map FuchsiaMart, TILESET_POKECENTER, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map FuchsiaGym, TILESET_LAB, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_GYM_KANTO, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsBrothersHouse, TILESET_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map LavenderPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map LavenderPokecenter2FBeta, TILESET_POKECENTER, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route12Gate1F, TILESET_MUSEUM, INDOOR, LANDMARK_ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route12Gate2F, TILESET_MUSEUM, INDOOR, LANDMARK_ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map CeladonDeptStore1F, TILESET_POKECENTER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore2F, TILESET_POKECENTER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore3F, TILESET_POKECENTER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore4F, TILESET_POKECENTER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore5F, TILESET_POKECENTER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStore6F, TILESET_POKECENTER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonDeptStoreElevator, TILESET_POKECENTER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeladonPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeladonGym, TILESET_TRAIN_STATION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_GYM_KANTO, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route17Route18Gate2F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_17, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map ViridianGym, TILESET_TRAIN_STATION, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_GYM_KANTO, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ViridianMart, TILESET_POKECENTER, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route2Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route2Gate2F, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VictoryRoadGate, TILESET_GATE, GATE, LANDMARK_ROUTE_26, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianSchoolHouse, TILESET_HOUSE, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianNorthGate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianSouthGate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForest, TILESET_FOREST, FOREST, LANDMARK_VIRIDIAN_FOREST, MUSIC_DUNGEONS_2, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map SaffronGym, TILESET_UNDERGROUND, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_GYM_KANTO, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronMart, TILESET_POKECENTER, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEMON_CENTER_KANTO, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cherrygrove:
	...
	map Route30BusyManHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_30, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Plateau:
	table_width MAP_LENGTH, MapGroup_Plateau
	map Route22Gate, TILESET_MUSEUM, GATE, LANDMARK_ROUTE_22, MUSIC_VICTORY_ROAD_KANTO, FALSE, PALETTE_DAY, FISHGROUP_POND
	map Ruta23Kanto, TILESET_PLATEAU, ROUTE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD_KANTO, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map IndigoPlateauKanto, TILESET_PLATEAU, ROUTE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD_KANTO, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	assert_table_length NUM_PLATEAU_MAPS