...
; Johto story events
	...
	const EVENT_CERULEAN_CAVE_1F_NUGGET ;added
	const EVENT_CERULEAN_CAVE_1F_FULL_RESTORE ; added
...
; Kanto story events
	...
	const EVENT_unused_event ; unused
	...
	const EVENT_GOT_TM07_WILD_CHARGE
...
; Route 19 New Trainers
	const EVENT_BEAT_ANIA
	const EVENT_BEAT_MARCELO
	const EVENT_BEAT_TONI
	const EVENT_BEAT_MATEO
	const EVENT_BEAT_ALEJO
; Route 6 New Trainers
	const EVENT_BEAT_KEIGO
	const EVENT_BEAT_ELIJAH
	const EVENT_BEAT_NEREA
	const EVENT_BEAT_CHIO
; Route 11 New Trainers
	const EVENT_BEAT_PERICO
	const EVENT_BEAT_BERNARDO
	const EVENT_BEAT_GASPAR
	const EVENT_BEAT_DARIAN
	const EVENT_BEAT_JAREN
	const EVENT_BEAT_HUGUE
	const EVENT_BEAT_DAVI
; Route 3 New Trainers
	const EVENT_BEAT_CORNELIO
	const EVENT_BEAT_GREGORIO
	const EVENT_BEAT_BUG_CATCHER_JAIME
; Route 8 New Trainers
	const EVENT_BEAT_GENO
	const EVENT_BEAT_LULU
	const EVENT_BEAT_ANDREA
	const EVENT_BEAT_VEVA
	const EVENT_BEAT_NORBER
	const EVENT_BEAT_EUSEBIO
	const EVENT_BEAT_LADIS
	const EVENT_BEAT_ADRIAN
; Route 10 North New Trainers
	const EVENT_BEAT_HERNANDO
	const EVENT_BEAT_HILARIA
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_BEAT_DACIO
	const EVENT_GOT_GS_BALL_FROM_GOLDENROD_POKEMON_CENTER
	const EVENT_BEAT_RAMON
; Route 9 New Trainers
	const EVENT_BEAT_NELI
	const EVENT_BEAT_NOE
	const EVENT_BEAT_ADOLFO
	const EVENT_BEAT_ALFONSO
	const EVENT_BEAT_BALTASAR
	const EVENT_BEAT_BERNABE
	const EVENT_BEAT_ARIEL
; Route 13 New Trainers
	const EVENT_BEAT_GEMA
	const EVENT_BEAT_VALERIA
	const EVENT_BEAT_SUSI
	const EVENT_BEAT_ALMA
	const EVENT_BEAT_ROBERTO
	const EVENT_BEAT_PASTOR
	const EVENT_BEAT_SEBASTIAN
	const EVENT_BEAT_JAVIER
; Route 14 New Trainers
	const EVENT_BEAT_GERARDO
	const EVENT_BEAT_ISAAC
	const EVENT_BEAT_MALEN
	const EVENT_BEAT_LUCIO
	const EVENT_BEAT_BENI
	const EVENT_BEAT_MAURO
; Route 15 New Trainers
	const EVENT_BEAT_BETINA
	const EVENT_BEAT_CLEO
	const EVENT_BEAT_CELIA
	const EVENT_BEAT_GRACIA
	const EVENT_BEAT_ERNESTO
	const EVENT_BEAT_SANDRO
	const EVENT_BEAT_CELSO
	const EVENT_BEAT_EDGARDO
; Unused: next 137 events
...
; Camper
	...
	const EVENT_BEAT_RICHI
	const EVENT_BEAT_GENARO
	const EVENT_BEAT_CAMPER_TED
	const EVENT_BEAT_CAMPER_TODD2
	const EVENT_BEAT_CAMPER_TODD3
	const EVENT_BEAT_CRIS
	const EVENT_BEAT_DOROTEO
	const EVENT_BEAT_JUSTI
	const_skip
...
; Firebreather
	...
	const EVENT_BEAT_DARIO2
	const EVENT_BEAT_NERON
...
; Beauty
	...
	const EVENT_BEAT_LUCRECIA
	const EVENT_BEAT_SUSANA
	const EVENT_BEAT_ROBERTA
	const EVENT_BEAT_BEAUTY_CASSIE
	const EVENT_BEAT_MANOLA
	const EVENT_BEAT_SOL
	const_skip
	const_skip
	const_skip
	const_skip
...
; CooltrainerM
	...
	const EVENT_BEAT_ERICK
	const EVENT_BEAT_ANDY
	const EVENT_BEAT_ELIAS
...
; Super Nerd
	...
	const EVENT_BEAT_ENRIQUE
	const EVENT_BEAT_AVERO
...
; SwimmerM
	...
	const EVENT_BEAT_ROMAN
	const EVENT_BEAT_JEROMO
	const EVENT_BEAT_OMAR
	const EVENT_BEAT_SERGIO
	const EVENT_BEAT_SWIMMER_BORIS
	const EVENT_BEAT_SWIMMERM_JEROME
	const EVENT_BEAT_SWIMMERM_TUCKER
	const EVENT_BEAT_DINO
	const EVENT_BEAT_SWIMMERM_CAMERON
	const EVENT_BEAT_SWIMMERM_SETH
	const EVENT_BEAT_DARIO
	const EVENT_BEAT_RICARDO
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_CIRO
	const EVENT_BEAT_DANE
	const EVENT_BEAT_PEPE
	const EVENT_BEAT_STEVE
	const EVENT_BEAT_FRANCIS
	const EVENT_BEAT_UBALDO
	const EVENT_BEAT_NOBORU
	const EVENT_BEAT_ELIA
	const EVENT_TEMPORARY_UNTIL_MAP_RELOAD_10
	const EVENT_BEAT_ANGELICA_CHANNELER
	const EVENT_BEAT_JULIANA
	const EVENT_BEAT_EMILIA
	const EVENT_POKEMON_TOWER_6F_RARE_CANDY
	const EVENT_POKEMON_TOWER_6F_FULL_RESTORE
	const EVENT_POKEMON_TOWER_6F_HIDDEN_SPELL_TAG
	const EVENT_BEAT_TAMARA
	const EVENT_BEAT_JANA
	const EVENT_BEAT_LINA
	const EVENT_BEAT_RENATA
	const EVENT_POKEMON_TOWER_5F_NUGGET
	const EVENT_POKEMON_TOWER_4F_PP_UP
	const EVENT_POKEMON_TOWER_4F_ESCAPE_ROPE
	const EVENT_POKEMON_TOWER_4F_ELIXER
	const EVENT_BEAT_PAULA_CHANNELER
	const EVENT_BEAT_JIMENA
	const EVENT_BEAT_LORENA
	const EVENT_BEAT_ESPE
	const EVENT_BEAT_CARI
	const EVENT_BEAT_PATRICIA
	const EVENT_POKEMON_TOWER_3F_HIDDEN_PP_UP
	const EVENT_BEAT_CEFE
	const EVENT_BEAT_JAVI
	const EVENT_BEAT_DERO
	const EVENT_BEAT_RALE
	const EVENT_BEAT_ISAIAS
	const EVENT_BEAT_BIKER_LAO
	const EVENT_BEAT_HIDEO
	const EVENT_BEAT_CADEL
	const EVENT_BEAT_LEO
	const EVENT_BEAT_BALD_KOJI
	const EVENT_BULBASAUR_HAPPINESS
	const EVENT_OPENED_CINNABAR_BLOCKADE_1
	const EVENT_OPENED_CINNABAR_BLOCKADE_2
	const EVENT_OPENED_CINNABAR_BLOCKADE_3
	const EVENT_OPENED_CINNABAR_BLOCKADE_4
	const EVENT_OPENED_CINNABAR_BLOCKADE_5
	const EVENT_OPENED_CINNABAR_BLOCKADE_6
	const EVENT_OPENED_CINNABAR_BLOCKADE_7
	const EVENT_BEAT_EMILIO
	const EVENT_BEAT_NARCISO
	const EVENT_BEAT_CLAUDIO
	const EVENT_BEAT_GUIDO
	const EVENT_BEAT_RONALDO
	const EVENT_BEAT_PICNICKER_IRENE
	const EVENT_BEAT_MERCE
	const EVENT_BEAT_ROGE
; Route 10 South New Trainers
	const EVENT_BEAT_MARCO
; Route 10 South New Trainers
	const EVENT_BEAT_CHICHO
	const EVENT_BEAT_NESTOR
	const EVENT_BEAT_MONE
; MonteMoonGrande New Items
	const MONTE_MOON_GRANDE_1F_RARECANDY
	const MONTE_MOON_GRANDE_B2F_MAX_REVIVE
	const MONTE_MOON_GRANDE_B2F_THIEF
	const MONTE_MOON_GRANDE_HIDDEN_MAX_REVIVE
	const MONTE_MOON_GRANDE_HIDDEN_MOONSTONE
	const MONTE_MOON_GRANDE_HIDDEN_MAX_POTION
	const MONTE_MOON_GRANDE_HIDDEN_STARDUST
	const MONTE_MOON_GRANDE_HIDDEN_SHROOM
	const MONTE_MOON_GRANDE_HIDDEN_TINYSHROOM
	const MONTE_MOON_GRANDE_HIDDEN_PP_UP
	const MONTE_MOON_GRANDE_HIDDEN_NUGGET
	const MONTE_MOON_GRANDE_HIDDEN_NUGGET2
; MonteMoonGrande New Trainers
	const EVENT_BEAT_MARCOS
	const EVENT_BEAT_JOSE
	const EVENT_BEAT_MIRMA
	const EVENT_BEAT_IRIS
	const EVENT_BEAT_ROBI
	const EVENT_BEAT_CASIMIRO
	const EVENT_BEAT_GUSTAVO
	const EVENT_BEAT_JOHN2
	const EVENT_BEAT_MIGUEL
	const EVENT_BEAT_ALBERT2
;Route 4 West New events
	const EVENT_GOT_ROUTE_4_WEST_MAGIKARP
;Tunel Roca New Trainers
	const EVENT_BEAT_DORA
	const EVENT_BEAT_ARIANA
	const EVENT_BEAT_LEA
	const EVENT_BEAT_LUCAS
	const EVENT_BEAT_OSCAR
	const EVENT_BEAT_LUCIANO
	const EVENT_BEAT_BASILIO
	const EVENT_BEAT_DANI
	const EVENT_BEAT_ESTEBAN
	const EVENT_BEAT_JULIAN
	const EVENT_BEAT_ALFREDO
	const EVENT_BEAT_EVARISTO
	const EVENT_BEAT_DINIO
	const EVENT_BEAT_MARTA
...
; New to Crystal
	...
	const EVENT_POKEMON_MANSION_1F_HP_UP
	const EVENT_POKEMON_MANSION_1F_ESCAPE_ROPE
	const EVENT_POKEMON_MANSION_2F_PP_UP
	const EVENT_POKEMON_MANSION_3F_GORGEOUS_BOX
	const EVENT_POKEMON_MANSION_3F_IRON
	const EVENT_POKEMON_MANSION_ULTRABALL
	const EVENT_POKEMON_MANSION_B1F_RARE_CANDY
	const EVENT_POKEMON_MANSION_B1F_SOLAR_BEAM
	const EVENT_POKEMON_MANSION_B1F_BLIZZARD
	const EVENT_MANSION_SWITCH_ON
	const EVENT_POKEMON_MANSION_B1F_FULL_RESTORE
	const EVENT_POKEMON_MANSION_B1F_HIDDEN_ELIXIR
	const EVENT_POKEMON_MANSION_B1F_HIDDEN_RARE_CANDY
	const EVENT_POKEMON_MANSION_3F_SMOKEBALL
	const EVENT_POKEMON_MANSION_3F_BERSERK_GENE
	const EVENT_POKEMON_MANSION_2F_CALCIUM
	const EVENT_POKEMON_MANSION_2F_MAX_REVIVE
	...
	const EVENT_FOUGHT_POWER_PLANT_ZAPDOS
	const EVENT_POWER_PLANT_ZAPDOS
	const EVENT_POWERPLANT_FULL_RESTORE
	const EVENT_POWERPLANT_HIDDEN_RARE_CANDY
	const EVENT_POWERPLANT_PSYCH_UP
	const EVENT_POWERPLANT_RARE_CANDY
	const EVENT_POWERPLANT_PP_UP
	const EVENT_POWERPLANT_THUNDER_STONE
	const EVENT_BEAT_CIRILO_VIRIDIAN_FOREST
	const EVENT_BEAT_LINO_VIRIDIAN_FOREST
	const EVENT_BEAT_AMADEO_VIRIDIAN_FOREST
	const EVENT_BEAT_ASIER_VIRIDIAN_FOREST
	const EVENT_BEAT_MANLIO_VIRIDIAN_FOREST
	const EVENT_VIRIDIAN_FOREST_NUGGET
	const EVENT_VIRIDIAN_FOREST_BIG_MUSHROOM
	const EVENT_VIRIDIAN_FOREST_LEAF_STONE
	const EVENT_VIRIDIAN_FOREST_FURY_CUTTER
	const EVENT_VIRIDIAN_FOREST_RARE_CANDY
	const EVENT_VIRIDIAN_FOREST_PP_UP
	const EVENT_TEMPORARY_UNTIL_MAP_RELOAD_9
	const EVENT_GAVE_KANTO_SCIENTIST_OLD_AMBER
	const EVENT_GAVE_KANTO_SCIENTIST_DOME_FOSSIL
	const EVENT_GAVE_KANTO_SCIENTIST_HELIX_FOSSIL
	const EVENT_GOT_LAST_STARTER
