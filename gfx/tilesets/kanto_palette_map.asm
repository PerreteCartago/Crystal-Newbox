	...
	tilepal 0, ROOF, RED, RED, RED, ROOF, ROOF, ROOF, ROOF
	tilepal 0, GRAY, GRAY, GRAY, BROWN, BROWN, BROWN, ROOF, ROOF
	tilepal 0, ROOF, RED, RED, RED, ROOF, ROOF, ROOF, TEXT
	tilepal 1, GRAY, GRAY, GRAY, BROWN, BROWN, BROWN, ROOF, ROOF
	tilepal 1, ROOF, RED, RED, RED, YELLOW, GRAY, BROWN, GRAY
	tilepal 1, RED, RED, RED, RED, RED, RED, RED, RED
	tilepal 1, RED, RED, GRAY, BROWN, BROWN, GRAY, BROWN, GRAY
	tilepal 1, RED, RED, RED, RED, RED, RED, RED, RED
	tilepal 1, RED, RED, GRAY, GRAY, GREEN, GREEN, GREEN, GRAY
