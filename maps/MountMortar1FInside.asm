	...
	const MOUNTMORTAR1FINSIDE_SUPER_NERD
	const MOUNTMORTAR1FINSIDE_POKEMANIAC
...
MountMortar1FInside_MapEvents:
	...
	object_event 33, 43, SPRITE_POKEMANIAC, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerPokemaniacMiller, -1
