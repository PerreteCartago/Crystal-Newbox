...
DEF GOLDENRODUNDERGROUND_YOUNGER_HAIRCUT_PRICE EQU 300
	...
	const GOLDENRODUNDERGROUND_POKEMANIAC1
	const GOLDENRODUNDERGROUND_POKEMANIAC2
...
GoldenrodUnderground_MapEvents:
	...
	object_event  3, 27, SPRITE_POKEMANIAC, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerPokemaniacIssac, -1
	object_event  2,  6, SPRITE_POKEMANIAC, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerPokemaniacDonald, -1
