	object_const_def
	const ROUTE35_STANDING_CAMPER1
	const ROUTE35_STANDING_CAMPER2
	const ROUTE35_LASS1
	const ROUTE35_LASS2
	const ROUTE35_BIRD_KEEPER
...
Route35_MapEvents:
	...
	def_object_events
	object_event  4, 19, SPRITE_CAMPER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 1, TrainerCamperIvan, -1
	object_event  8, 20, SPRITE_CAMPER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 1, TrainerCamperElliot, -1
