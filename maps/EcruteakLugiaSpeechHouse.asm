...
EcruteakLugiaSpeechHouseGrampsText:
	...
	para "Un enorme Pokémon"
	line "estaba tapando el"
	cont "sol."

	para "Me pregunto qué"
	line "sería ese Pokémon,"
...
EcruteakLugiaSpeechHouse_MapEvents:
	...
	def_object_events
	object_event  2,  3, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, EcruteakLugiaSpeechHouseGrampsScript, -1
