	object_const_def
	const ROUTE38_STANDING_SCHOOL_BOY
	const ROUTE38_LASS
	const ROUTE38_STANDING_BIRD_KEEPER
...
Route38_MapEvents:
	...
	def_object_events
	object_event  4,  1, SPRITE_SCHOOL_BOY, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 1, TrainerSchoolboyChad1, -1
